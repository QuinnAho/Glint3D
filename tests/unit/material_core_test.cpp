...
#include <cmath>
#include <glm/glm.hpp>
#include "../../engine/include/material_core.h" // Use internal header to match implementation symbols
...
int main() {
    std::cout << "Running MaterialCore tests...\n";
    ...
    // Test 1: Default constructor creates valid dielectric
    {
        ...
        std::cout << "[OK] Default constructor creates valid dielectric" << std::endl;
    }
    ...
    // Test 2: Metal factory constructor
    {
        ...
        std::cout << "[OK] Metal factory creates valid metallic material" << std::endl;
    }
    ...
    // Test 3: Glass factory constructor
    {
        ...
        std::cout << "[OK] Glass factory creates valid transparent material" << std::endl;
    }
    ...
    // Test 4: Emissive factory constructor
    {
        ...
        std::cout << "[OK] Emissive factory creates valid light-emitting material" << std::endl;
    }
    ...
    // Test 5: Transparency detection
    {
        ...
        std::cout << "[OK] Transparency detection works correctly" << std::endl;
    }
    ...
    // Test 6: Raytracing requirement detection
    {
        ...
        std::cout << "[OK] Raytracing requirement detection works correctly" << std::endl;
    }
    ...
    // Test 7: Value validation and clamping
    {
        ...
        std::cout << "[OK] Value validation and clamping work correctly" << std::endl;
    }
    ...
    // Test 8: Physically plausible combinations
    {
        ...
        std::cout << "[OK] Physically implausible combination detected (metallic + transparent)" << std::endl;
    }
    ...
    // Test 9: BSDF parameter ranges
    {
        ...
        std::cout << "[OK] BSDF parameter ranges are correctly enforced" << std::endl;
    }
    ...
    // Test 10: Unified material eliminates dual storage issues
    {
        ...
        std::cout << "[OK] Unified MaterialCore eliminates dual storage conversion drift" << std::endl;
    }

    std::cout << "\n[PASS] MaterialCore tests summary:\n";
