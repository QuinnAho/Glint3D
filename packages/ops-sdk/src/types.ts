// Generated TypeScript types for Glint3D JSON Ops v1.3
// Source: ../../schemas/json_ops_v1.json
...
// JSON Ops can be a single operation or an array
export type JsonOps = JsonOp | JsonOp[];

// Scene state types for engine communication
